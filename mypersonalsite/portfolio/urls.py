...
from . import views
from .views import ProjectDetailView, ReviewCreateView, ViewEducationDetail, ViewJobExperienceDetail, ViewCertificateDetail
...
urlpatterns = [
    ...
    #Eductaion, Certifcate and Job Experiences detail

...
class Project(models.Model):
    ...
    technologies = models.CharField(
        max_length=200, help_text="Comma-separated list of technologies used."
    )
    public_url = models.URLField(
        blank=True, null=True, help_text="Public link, e.g., GitHub or live demo."
    )
    private_url = models.URLField(
        blank=True, null=True, help_text="Private link, e.g., Google Drive or restricted resource."
    )
    is_public = models.BooleanField(
        default=True, help_text="Flag to indicate if project is publicly visible."
    )
    google_file_id = models.CharField(
        max_length=100,
        blank=True,
        null=True,
        help_text="Google File ID for embedding a presentation.",
    )
...
class File(models.Model):
    ...
    is_private = models.BooleanField(
        default=False, help_text="Flag to indicate if the file is private."
    )
...
class ContactInfo(models.Model):
    ...
    linkedin_url = models.URLField(
        max_length=200, blank=True, null=True, help_text="LinkedIn profile URL of the site owner."
    )
    github_url = models.URLField(
        max_length=200, blank=True, null=True, help_text="GitHub profile URL of the site owner."
    )
...
class Skill(models.Model):
    ...
    name = models.CharField(
        max_length=100, unique=True, help_text="The name of the skill (e.g., Python, Data Analysis)."
    )
...
class Certificate(models.Model):
    ...
    field = models.CharField(
        ...
        blank=True,
        null=True,
        help_text="Optional field to specify the category or context of the certificate.",
    )
    ...
    image = models.ImageField(
        ...
        blank=True,
        null=True,
        help_text="Upload an image for the certificate.",
    )
    ...
    skills = models.ManyToManyField(
        ...
        blank=True,
        help_text="Skills related to this certificate.",
    )
...
class Education(models.Model):
    ...
    institution = models.CharField(
        max_length=255, help_text="Name of the educational institution."
    )
    degree = models.CharField(
        max_length=50, choices=DEGREE_CHOICES, help_text="Degree type (e.g., Bachelor's, Master's)."
    )
    field_of_study = models.CharField(
        max_length=255, help_text="Field of study (e.g., Computer Science)."
    )
    ...
    description = models.TextField(
        blank=True, help_text="Optional description of the program or notable achievements."
    )
    skills = models.ManyToManyField(
        Skill,
        related_name="educations",
        blank=True,
        help_text="Skills related to this educational entry.",
    )
...
class Review(models.Model):
    ...
    project = models.ForeignKey(
        ...
        on_delete=models.CASCADE,
        help_text="The project this review is associated with."
    )
    reviewer_name = models.CharField(
        max_length=100, help_text="Name of the reviewer submitting the review."
    )
    content = models.TextField(help_text="Content of the review.")
    recommendation = models.BooleanField(
        default=False, help_text="Does the reviewer recommend this project?"
    )
    status = models.CharField(
        max_length=10,
        choices=STATUS_CHOICES,
        default='pending',
        help_text="Approval status of the review."
    )
    created_at = models.DateTimeField(
        auto_now_add=True, help_text="Timestamp for when the review was created."
    )
...
class JobExperience(models.Model):
    ...
    title = models.CharField(
        max_length=255, help_text="Job title (e.g., Software Developer)"
    )
    ...
    end_date = models.DateField(
        null=True,
        blank=True,
        help_text="End date of the job (if applicable)"
    )
    description = models.TextField(
        blank=True, help_text="Description of responsibilities or achievements"
    )
    skills = models.ManyToManyField(
        'Skill',
        related_name="job_experiences",
        blank=True,
        help_text="Skills related to this job experience"
    )
...
class Section(models.Model):
    ...
    description = models.TextField(
        help_text="Description content for the section",
...
class Category(models.Model):
    ...
    slug = models.SlugField(
        ...
        unique=True,
        blank=True,
        help_text="URL-friendly identifier for the category (auto-generated)."
    )
...
class BlogPost(models.Model):
    ...
    slug = models.SlugField(
        ...
        unique=True,
        blank=True,
        help_text="URL-friendly identifier for the post (auto-generated)."
    )
    content = models.TextField(help_text="Main content of the blog post.")
    excerpt = models.TextField(
        blank=True, help_text="Short summary or excerpt of the blog post."
    )
    ...
    publication_date = models.DateField(
        auto_now_add=True, help_text="Date the blog post was published."
    )
    categories = models.ManyToManyField(
        Category,
        related_name='blog_posts',
        help_text="Categories associated with the blog post."
    )
